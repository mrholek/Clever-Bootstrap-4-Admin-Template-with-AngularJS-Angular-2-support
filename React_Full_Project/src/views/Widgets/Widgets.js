      ...
      <div className="animated fadeIn">
        ...
        <div className="row">
          <div className="col-6 col-lg-3">
            <div className="card">
              <div className="card-block p-1 clearfix">
                <i className="fa fa-cogs bg-primary p-1 font-2xl mr-1 float-left"></i>
          ...
          <div className="col-6 col-lg-3">
            <div className="card">
              ...
              <div className="card-footer px-1 py-h">
        ...
        <div className="row">
          ...
          <div className="col-6 col-lg-3">
            <div className="card">
              <div className="card-block p-0 clearfix">
                <i className="fa fa-cogs bg-primary p-2 font-2xl mr-1 float-left"></i>
                <div className="h5 text-primary mb-0 pt-1">$1.999,50</div>
                <div className="text-muted text-uppercase font-weight-bold font-xs">Income</div>
              </div>
            </div>
          </div>
          ...
          <div className="col-6 col-lg-3">
            <div className="card">
              <div className="card-block p-0 clearfix">
                <i className="fa fa-laptop bg-info p-2 font-2xl mr-1 float-left"></i>
                <div className="h5 text-info mb-0 pt-1">$1.999,50</div>
                <div className="text-muted text-uppercase font-weight-bold font-xs">Income</div>
              </div>
            </div>
          </div>
          ...
          <div className="col-6 col-lg-3">
            <div className="card">
              <div className="card-block p-0 clearfix">
                <i className="fa fa-moon-o bg-warning p-2 font-2xl mr-1 float-left"></i>
                <div className="h5 text-warning mb-0 pt-1">$1.999,50</div>
                <div className="text-muted text-uppercase font-weight-bold font-xs">Income</div>
              </div>
            </div>
          </div>
          ...
          <div className="col-6 col-lg-3">
            <div className="card">
              <div className="card-block p-0 clearfix">
                <i className="fa fa-bell bg-danger p-2 font-2xl mr-1 float-left"></i>
                <div className="h5 text-danger mb-0 pt-1">$1.999,50</div>
                <div className="text-muted text-uppercase font-weight-bold font-xs">Income</div>
              </div>
            </div>
          </div>
          ...
          <div className="col-6 col-lg-3">
            <div className="card">
              <div className="card-block p-0 clearfix">
                <i className="fa fa-cogs bg-primary p-2 px-3 font-2xl mr-1 float-left"></i>
                <div className="h5 text-primary mb-0 pt-1">$1.999,50</div>
                <div className="text-muted text-uppercase font-weight-bold font-xs">Income</div>
              </div>
            </div>
          ...
          <div className="col-6 col-lg-3">
            <div className="card">
              <div className="card-block p-0 clearfix">
                <i className="fa fa-laptop bg-info p-2 px-3 font-2xl mr-1 float-left"></i>
                <div className="h5 text-info mb-0 pt-1">$1.999,50</div>
                <div className="text-muted text-uppercase font-weight-bold font-xs">Income</div>
              </div>
            </div>
          ...
          <div className="col-6 col-lg-3">
            <div className="card">
              <div className="card-block p-0 clearfix">
                <i className="fa fa-moon-o bg-warning p-2 px-3 font-2xl mr-1 float-left"></i>
                <div className="h5 text-warning mb-0 pt-1">$1.999,50</div>
                <div className="text-muted text-uppercase font-weight-bold font-xs">Income</div>
              </div>
            </div>
          ...
          <div className="col-6 col-lg-3">
            <div className="card">
              <div className="card-block p-0 clearfix">
                <i className="fa fa-bell bg-danger p-2 px-3 font-2xl mr-1 float-left"></i>
                <div className="h5 text-danger mb-0 pt-1">$1.999,50</div>
                <div className="text-muted text-uppercase font-weight-bold font-xs">Income</div>
              </div>
            </div>
        ...
        <div className="card-group">
          <div className="card">
            <div className="card-block">
              ...
              <Progress className="progress progress-xs mt-1 mb-0" color="info" value="25" />
            </div>
          </div>
          <div className="card">
            <div className="card-block">
              ...
              <Progress className="progress progress-xs mt-1 mb-0" color="success" value="25" />
            </div>
          </div>
          <div className="card">
            <div className="card-block">
              ...
              <Progress className="progress progress-xs mt-1 mb-0" color="warning" value="25" />
            </div>
          </div>
          <div className="card">
            <div className="card-block">
          ...
          <div className="card">
            <div className="card-block">
              ...
              <Progress className="progress progress-xs mt-1 mb-0" color="danger" value="25" />
            </div>
          </div>
        </div>
